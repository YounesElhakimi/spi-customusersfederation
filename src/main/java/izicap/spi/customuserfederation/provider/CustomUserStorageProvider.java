package izicap.spi.customuserfederation.provider;

import izicap.spi.customuserfederation.models.CustomUser;
import izicap.spi.customuserfederation.models.CustomUserRepository;
import izicap.spi.customuserfederation.models.UserAdapter;
...
public class CustomUserStorageProvider implements UserStorageProvider,
    ...
    public CustomUserStorageProvider(KeycloakSession session, ComponentModel model, CustomUserRepository repository) {
    ...
    public UserModel getUserByUsername(RealmModel realm, String username) {
        CustomUser user = repository.findUserByUsernameOrEmail(username);
        if (user != null) {
